...
function buildMenuItems(gridItemId) {
  ...
  const menuBarConfig = ContentSynchronizer.getItem(
    'menus', 'menuId', menuBar.gridContent.menuId, true);
...
function buildMenuFilterItems(gridItemId) {
  ...
  const filterBar = ContentSynchronizer.getItem(
    'grids', 'gridItemId', gridItemId, true);
  const filterBarConfig = ContentSynchronizer.getItem(
    'menus', 'menuId', filterBar.gridContent.menuId, true);
  const {
    collectionName,
    menuItemType,
...
function buildProductMenuItems(gridItemId) {
  ...
  const productsBar = ContentSynchronizer.getItem(
    'grids', 'gridItemId', gridItemId, true);
  //console.log(productsBar);
  const productsBarConfig = ContentSynchronizer.getItem(
     'menus', 'menuId', productsBar.gridContent.menuId, true);
